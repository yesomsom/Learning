...
<!-- form -->
<form method="post" action="memberForm.jsp" onsubmit="return Validation();">
...
<!-- 체크 항목 & textarea -->
		<tbody>
			<tr>
				<td><input id="required_check_first" type="checkbox" name="chk"></td>
			...
			<tr>
				<td><input id="required_check_second" type="checkbox" name="chk"></td>
...
<!-- 버튼 button -->
	<div id="button_all">
		<input class="btn" type="submit" value="동의">
