		...
		<table>
			...
			<tr>
				<td class="order_detail_goods">
					<div>
						<img alt="" src="img/study1.jpg" width="150px">
					</div>
					<div class="order_detail_goods_des">
						그린 아트<br>
						컨퍼런스 룸 1005호, 중형 회의실<br>
						성인 10명<br>
				...
				<td>
					<span class="font_bold">취소 완료</span><br>
					9/5(월) 이내 카드사 환불 완료 예정
				</td>
			</tr>
		</table>	
	</div>
		...
		<table>
			...
			<tr>
				<td class="gbcolor_td">
					...
					<div class="font_right font_color_red">
					  	120,000원
					</div>
				</td>
			</tr>
...
<!-- 테이블 아래 환불 공지 문구 -->
		<div class="align_right">
			<img class="align_right_img" alt="importance" src="img/icons8-high-importance-19 (1).png">
			카드사로 결제 취소 요청에 전달 된 후 환불까지 평일 기준 3~5일이 소요됩니다.
		</div>
	</div>
