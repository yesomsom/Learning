...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="${path}/css}/css/myReservation.css">
...
<!-- top icon (지난 예약) -->
		<div class="reser_icon_set">
			<div class="reser_icon_img">
				<a href="#"><img alt="지난 예약" src="${path}/img/icons8-timesheet-70 (1).png"></a>
			</div>
			<div class="reser_icon_ct">
				<a href="#">지난 예약</a>
			</div>
...
<!-- top icon (예약 취소) -->
		<div class="reser_icon_set">
			<div class="reser_icon_img">
				<a href="#"><img alt="예약 취소" src="${path}/img/icons8-delete-document-70.png"></a>
			</div>
			<div class="reser_icon_ct">
				<a href="#">예약 취소</a>
			</div>
