...
public class TheaterController {
	...
	public String theater(ModelMap model, Criteria cri) throws Exception {
	...
	@RequestMapping(value = "/theater_ajax",method = RequestMethod.GET, produces="application/text;charset=UTF-8")
