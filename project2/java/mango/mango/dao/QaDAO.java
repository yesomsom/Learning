...
public class QaDAO extends ComAbstractDAO  {
	//공지 조회
	public List<QaVO> selectAllQaList(QaVO vo) throws Exception {
		return selectList("QaMapper.selectAllQaList", vo);
	}
	
	public Integer selectAllQaCount(QaVO vo) throws Exception{
		return selectOne("QaMapper.selectAllQaCount", vo);
	}
