         ...
         <form action="register/insert.do" id="registerForm" method="post" >
            ...
            <div class="form-wrapper phone_num">
               <input type="text" name="phoneNumber" placeholder="휴대폰번호"
                  class="form-control" id="phoneNumber" readonly> <i class="zmdi  zmdi-phone"></i>
            ...
            <div class="form-wrapper">
              <input class="form-control" type="text" placeholder="도로명주소" style="width:315px;" id="roadFullAddr"  name="roadFullAddr" readonly/>              
              <i class="zmdi  zmdi-phone"></i>
            </div>
