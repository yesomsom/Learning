...
<h3>sms인증페이지</h3>
<div id="contents">
<form action="${path }/page/sendSms/insert.do" method="post">
...
<script type="text/javascript">
   function setParaentText(){
      opener.document.getElementById("phoneNumber").value = document.getElementById("to").value
...
<!-- 휴대폰 번호 유효성 검사 -->
  <script>
function Phonecheck() {
   var objPhoneNum = document.getElementById("phoneNumber");
